...
\frametitle{Third Isomorphism Theorem}
	\begin{figure}
		\begin{tikzpicture}
		\draw<3>[green,fill = green] (6.55,1.15) rectangle (6.85,1.45);
		\draw<3>[green,fill = green] (2.05,0.05) rectangle (3.95,1.95);
		...
		\draw<3->[green,fill=green] (8.6,1.4) circle[radius=0.03];
